...
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=dfsgotl-lenya_NetSdrClient&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=dfsgotl-lenya_NetSdrClient)
[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=dfsgotl-lenya_NetSdrClient&metric=coverage)](https://sonarcloud.io/summary/new_code?id=dfsgotl-lenya_NetSdrClient)
[![Bugs](https://sonarcloud.io/api/project_badges/measure?project=dfsgotl-lenya_NetSdrClient&metric=bugs)](https://sonarcloud.io/summary/new_code?id=dfsgotl-lenya_NetSdrClient)
[![Code Smells](https://sonarcloud.io/api/project_badges/measure?project=dfsgotl-lenya_NetSdrClient&metric=code_smells)](https://sonarcloud.io/summary/new_code?id=dfsgotl-lenya_NetSdrClient)
[![Vulnerabilities](https://sonarcloud.io/api/project_badges/measure?project=dfsgotl-lenya_NetSdrClient&metric=vulnerabilities)](https://sonarcloud.io/summary/new_code?id=dfsgotl-lenya_NetSdrClient)
